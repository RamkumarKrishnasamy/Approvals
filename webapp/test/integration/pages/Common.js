sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/ram/app/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.ram.app.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/ram/app/localService/mockserver"], function (mockserver) {
